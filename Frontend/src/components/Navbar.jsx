          ...
          <div className="hidden md:flex space-x-4">
            {!isAuthenticated ? (
              ...
              <button
                ...
                className="px-4 py-1.5 bg-white font-semibold border-2 border-red-500 text-red-500 rounded-xl cursor-pointer hover:bg-red-500 hover:text-white transition"
              >
                Signout
              </button>
            )}
        ...
        <div className="md:hidden border-t border-gray-200 px-4 py-6">
          ...
          <div className="mt-6 pt-4 border-t border-gray-200 flex justify-center gap-4">
            {!isAuthenticated ? (
              ...
              <button
                onClick={() => setIsModalOpen(true)} 
                className="px-6 py-2 bg-white border-2 font-semibold border-red-500 text-red-500 hover:bg-red-500 hover:text-white rounded-xl cursor-pointer"
              >
                Signout
              </button>
            )}
